...
function UpadateProduct({img}  : any ) {
    ...
    const [productimg, setProductimg] = useState<Blob>();
    ...
    return (
        <div>
            <label htmlFor="my-modal-4" className="btn modal-button btn-sm btn-success ">edit</label>
                    ...
                    <div>
                        <div className='flex flex-col gap-5 '>
                            <div className='w-full'>
                                <img src={productimg ? URL.createObjectURL(productimg!) : img } alt="product img" className="text-center my-3 rounded-md mx-auto" />
                            </div>
